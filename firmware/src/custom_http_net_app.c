...
void HTTP_APP_Initialize(void)
{
    ...
    {
        .getExecute = TCPIP_HTTP_NET_ConnectionGetExecute,
        .postExecute = TCPIP_HTTP_NET_ConnectionPostExecute,
        .fileAuthenticate = TCPIP_HTTP_NET_ConnectionFileAuthenticate,
        .userAuthenticate = TCPIP_HTTP_NET_ConnectionUserAuthenticate,
        .dynamicPrint = TCPIP_HTTP_NET_DynPrint,
        .dynamicAck = TCPIP_HTTP_NET_DynAcknowledge,
        .eventReport = TCPIP_HTTP_NET_EventReport,
    };
