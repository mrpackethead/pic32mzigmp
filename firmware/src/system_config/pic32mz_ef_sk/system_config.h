...
#define TCPIP_NETWORK_DEFAULT_IP_ADDRESS 			"10.10.23.99"
#define TCPIP_NETWORK_DEFAULT_IP_MASK 				"255.255.255.0"
#define TCPIP_NETWORK_DEFAULT_GATEWAY	 			"10.10.23.254"
...
#define TCPIP_NETWORK_DEFAULT_INTERFACE_FLAGS   		TCPIP_NETWORK_CONFIG_IP_STATIC | TCPIP_NETWORK_CONFIG_MULTICAST_ON
